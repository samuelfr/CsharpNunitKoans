	...
	public class K080_AboutNull : KoanHelper
	{
		...
		public void NullIsNotAnInstanceOfObjectAndInvokingAMethodThrowsNullReferenceException ()
		{
			...
			try {
				...
				Assert.AreEqual ("La référence d'objet n'est pas définie à une instance d'un objet.",
				                 exception.Message, "If you're still unsure, take a look at the name of this method...");
			}
		}
